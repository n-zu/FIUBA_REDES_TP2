...
from .fin_sent import ServerFinSent
from .disconnected import ServerDisconnected
from .disconnecting import ServerDisconnecting


class ServerSendingFin(ServerStateBase):
    ...
    def handle_fin(self, packet):
        ...
        self.saw_socket.set_state(ServerDisconnecting(self.saw_socket))
